...
//   angle         = ( 25.0 / 360 ) * 3.14159 * 2;      /* use 25 degrees     */
  ...
  /* use 50pt at 100dpi */
  error = FT_Set_Char_Size( face, CHAR_DIM, 0, CHAR_RESOLUTION, 0 );                /* set character size */
  /* error handling omitted */
...
//   pen.x = 300 * 64;
  ...
  for ( n = 0; n < num_chars; n++ )
  {
	...
	std::cout << "arget_height - slot->bitmap_top: " << target_height - slot->bitmap_top << std::endl;
